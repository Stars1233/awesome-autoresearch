...
| XGBoost for tennis match prediction | Predict ATP/WTA match outcomes - encountered and documented reward hacking | Nick Oak | [Blog](https://nickoak.com/posts/tennis-xgboost-autoresearch/) · [GitHub](https://github.com/buildoak/tennis-xgboost-autoresearch) | [ROC-AUC trajectory & gaming taxonomy](https://nickoak.com/posts/tennis-xgboost-autoresearch/) |
